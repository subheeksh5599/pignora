...
Live desk: https://pignora-desk.vercel.app
...
Travel Rule-attributed with an append-only audit pack.
...
VERIFICATION
22 Foundry tests + 8 backend tests green; live desk + hosted API verified.
